...
pub fn build(
    ...
    build_opt(labels, rgb, alpha, fill_at, params, rank, true, true, levels)
}
...
pub fn build_opt(
    ...
    let placed = place(&chain_list, &edges, &padded, rgb, alpha, fill_at, &handed_back, levels);
