...
PRESETS: list[Preset] = [
    ...
    Preset(
        ...
        detail="ΔE 0.68 · 8 paths · 6 KB — 37% fewer nodes",
        sample="logo.png",
    ...
    Preset(
        ...
        detail="ΔE 0.53 — the closest match, at 2.2× the nodes",
        sample="detailed.png",
    ...
    Preset(
        ...
        detail="ΔE 1.45 · 21 paths — visibly posterised, by design",
        sample="flat.png",
    ...
    Preset(
        ...
        detail="ΔE 0.78 · 7 paths — about 5× faster",
        sample="dense.png",
    ...
    Preset(
        ...
        detail="ΔE 0.68 · 10 paths · every shape a closed outline",
        sample="cutfile.png",
